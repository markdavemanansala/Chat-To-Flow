...
export function getDefaultLabel(kind) {
  const labelMap = {
    ...
    'trigger.sheets.newRow': 'Sheets: New Row',
    'trigger.sheets.update': 'Sheets: Update',
    'logic.filter': 'Filter',
    'ai.guard': 'AI Guard',
    ...
    'action.telegram.sendPhoto': 'Telegram Photo',
    'action.telegram.sendVideo': 'Telegram Video',
    'action.telegram.sendAudio': 'Telegram Audio',
    'action.telegram.sendDocument': 'Telegram Document',
    'action.telegram.sendLocation': 'Telegram Location',
    'action.telegram.sendVenue': 'Telegram Venue',
    'action.telegram.sendContact': 'Telegram Contact',
    'action.telegram.sendPoll': 'Telegram Poll',
    'action.telegram.sendSticker': 'Telegram Sticker',
    'action.telegram.editMessage': 'Edit Telegram',
    'action.telegram.deleteMessage': 'Delete Telegram',
    'action.telegram.getUpdates': 'Get Telegram Updates',
    'action.email.send': 'Send Email',
    'action.sheets.appendRow': 'Add to Sheets',
    'action.sheets.readRows': 'Read Sheets',
    'action.sheets.updateCell': 'Update Cell',
    'action.sheets.clearRange': 'Clear Sheets',
