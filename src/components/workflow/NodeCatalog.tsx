...
const DEFAULT_CONFIGS: Record<string, any> = {
  ...
  'action.sheets.appendRow': { sheetId: '', range: 'Sheet1!A1', values: [] },
...
const GROUPS: { title: string; items: { kind: string; label: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { kind: 'action.telegram.sendMessage', label: 'Telegram: Send Message' },
      { kind: 'action.email.send', label: 'Email: Send' },
      { kind: 'action.sheets.appendRow', label: 'Sheets: Append Row' },
